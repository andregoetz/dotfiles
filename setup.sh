...
if [[ $1 == "-p" ]]; then
    ...
    yt-dlp qt5ct adwaita-qt5-git flameshot ani-cli monero-gui dino
    ...
    org.libreoffice.LibreOffice org.gimp.GIMP com.github.vladimiry.ElectronMail org.mozilla.Thunderbird com.github.jeromerobert.pdfarranger \
    ...
    com.github.xournalpp.xournalpp com.sigil_ebook.Sigil org.inkscape.Inkscape com.github.micahflee.torbrowser-launcher org.gtk.Gtk3theme.Mint-Y-Dark-Purple
else
